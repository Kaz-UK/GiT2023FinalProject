...
from application.forms.CustomerDetailsForm import CustomerDetailsForm
...
# @app.route('/customers/email', methods=['POST', 'GET'])
# def show_all_customer_details(email):
#     error = ""
...
#     email = form.email.data
        ...
        # email = form.email.data
        # if len(email) < 0:
        #     error = "There is no one with this email address"
        # else:
        #     service.show_all_customer_details(email)
        #     customer = Customer(customer_id=Customer.customer_id, first_name=Customer.first_name,
        #                         last_name=Customer.last_name, email=Customer.email,
        #                     phone_number=Customer.phone_number, account_status=Customer.account_status,
        #                     join_date=Customer.join_date)
        #     return render_template('customer_details.html', form=form, message=error, customer=customer)